# 0 "C:\\Users\\alexj\\Downloads\\vitis_part4\\platform\\hw\\sdt\\system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "C:\\Users\\alexj\\Downloads\\vitis_part4\\platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "C:\\Users\\alexj\\Downloads\\vitis_part4\\platform\\hw\\sdt\\pl.dtsi" 1
/ {
 ...
 amba_pl: amba_pl {
  ...
  axi_bram_ctrl_0: axi_bram_ctrl@c0000000 {
   ...
   reg = <0xc0000000 0x4000 0xc0000000 0x2000>;
  ...
  myip_pong2_0: myip_pong2@44b00000 {
   xlnx,rable = <0>;
...
# 3 "C:\\Users\\alexj\\Downloads\\vitis_part4\\platform\\hw\\sdt\\system-top.dts" 2
/ {
 device_id = "7s50";
 #address-cells = <1>;
 #size-cells = <1>;
 ...
 cpus_microblaze_riscv_0: cpus_microblaze_riscv@0 {
  address-map = <0xC0000000 &axi_bram_ctrl_0_memory 0xC0000000 0x2000>,
         ...
         <0x00000000 &microblaze_riscv_0_local_memory_dlmb_bram_if_cntlr_memory 0x00000000 0x40000>,
         <0x00000000 &microblaze_riscv_0_local_memory_dlmb_bram_if_cntlr 0x00000000 0x40000>,
         ...
         <0x44a10000 &axi_cdma_0 0x44a10000 0x10000>,
         <0x44b00000 &myip_pong2_0 0x44b00000 0x1000>;
